...
<div>
	Bienvenue M. ${lecteur.idLec} <br>
	
	<a href="logAut"><button class="btn btn-primary text-white">Post an article</button></a>
...
<c:forEach items="${articles}"  var="line">
        <div class="card col-3 mb-3 mx-2" style="height: max-content;">
